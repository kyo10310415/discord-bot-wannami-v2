...
【新規性のある企画提案の方法】
🆕 既存企画を分析した上で、次のステップを提案
   例: 「参加型配信」→「トーナメント大会」「チーム対抗戦」「視聴者コーチング」
🆕 現在のゲームに新しい制約・ルール・目標を追加
   例: 「ストリートファイター6」→「キャラ縛り」「ランクマラソン」「初心者講座」
🆕 視聴者との新しい交流方法を提案
   例: 「雑談配信」→「お悩み相談室」「企画投票」「コラボ配信」
🆕 配信時間・頻度・形式の新しいアプローチ
   例: 「通常配信」→「朝活配信」「24時間配信」「ショート動画シリーズ」

【企画提案の構成】
1. 最近の配信内容を具体的に分析
   例: 「最近は『ストリートファイター6』の参加型配信が人気で、視聴回数も安定」
   
2. **既存企画との差別化を明示した新企画を3つ提案**
   ❌ NG例: 「参加型配信を続けましょう」（既存の繰り返し）
   ✅ OK例: 「参加型配信を発展させ、月1回のトーナメント大会を開催」
   
3. 各企画の実施方法・差別化ポイント・期待される効果を説明
   - なぜ新しいのか？
   - 既存企画とどう違うのか？
   - どんな新しい価値を提供するのか？
