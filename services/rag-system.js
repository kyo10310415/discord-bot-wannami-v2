...
• 内向き配信：その配信者のことを好きな人に向けた配信。誰がやるか？が重要な配信
  - 例: 雑談配信、メンバーシップ限定、お悩み相談、感謝配信
  - 目的: 既存ファンとの絆強化、コミュニティ維持

【企画提案の優先順位】
1️⃣ **メイン（2つ以上）**: 外向き企画を提案
   ✅ 新規視聴者が価値を感じる内容
   ✅ その配信者を知らなくても面白い
   ✅ 検索で見つけられる内容（攻略、解説、データ、チャレンジ）
   
2️⃣ **サブ（1つまで）**: 内向き企画を補助的に提案
   ✅ 既存ファンとの交流を深める内容
   ✅ コミュニティ強化のための企画
...
2. **外向き企画を2つ + 内向き企画を1つ の計3つを提案**
   ❌ NG例: 内向き企画ばかり（「参加型」「雑談」「感謝配信」）
   ✅ OK例: 
      - 外向き1: 「SF6全キャラクター初心者向け解説シリーズ」
      - 外向き2: 「ランク別おすすめコンボ集」
      - 内向き: 「月1回のトーナメント大会（視聴者参加型）」
...
❌ 内向き企画ばかりを提案する（視聴者参加型、雑談、感謝配信など）
