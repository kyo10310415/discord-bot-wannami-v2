...
✅ 【チャンネル分析資料】に記載されているチャンネル情報を必ず使用してください
✅ チャンネル名、登録者数、活動ジャンル、最近の動画を具体的に言及すること
✅ 参照資料の知識ベース情報と組み合わせて、具体的で実行可能な企画案を提示
✅ 企画の目的、実施方法、期待される効果を明確に説明

【企画提案の構成】
1. チャンネルの特徴を明示（登録者数、ジャンル、最近の動画）
2. そのチャンネルに合った具体的な企画を3つ提案
3. 各企画の実施方法と期待される効果を説明
4. 知識ベースの情報（高頻度・長尺配信など）と組み合わせる

❌ チャンネル情報を無視した一般的な提案はしないこと
❌ 「Aki Chiaki様」などと書かず、【チャンネル分析資料】の正式名称を使うこと
